			...
			REM -- SRW
				...
				%WHILE0% (
					...
					IF !ERRORLEVEL! EQU 27 (
						%BREAK0%
					) ELSE IF !ERRORLEVEL! EQU 37 (
						%BREAK0%
					) ELSE IF !ERRORLEVEL! EQU 39 (
						%BREAK0%
					) ELSE (
						IF NOT DEFINED SYMODULE_PAT!TEMPVARI00! CALL :MAKE_BLANK_PATTERN !TEMPVARI00!
						CALL :MODIFY_FRAME !CURSOR_FRAME! !TEMPVARI00!
...
%WHILE1% (
	...
	IF !TEMPVARI05! LEQ 57 IF !TEMPVARI05! GEQ 48 (
		IF !TEMPVARI01! EQU 0 (
		...
		SET /A "TEMPVARI01+=1"
	) ELSE IF !TEMPVARI05! EQU 13 (
		SET "TEMPVARI01=2"
	) ELSE IF !TEMPVARI05! EQU 27 (
		SET "TEMPVARI01=2"
	) ELSE IF !TEMPVARI05! EQU 37 (
		SET "TEMPVARI01=2"
	) ELSE IF !TEMPVARI05! EQU 39 (
		SET "TEMPVARI01=2"
	)
