	...
	IF !CURR_TAV! EQU 0 (
		...
		IF !FRAMESHOWTEMP_CURSORINDEX! EQU 0 (
			IF !ERRORLEVEL! GEQ 65 IF !ERRORLEVEL! LEQ 90 (
				IF !ERRORLEVEL! EQU 90 SET BUFFER_INPUTNOTE=C-0
				IF !ERRORLEVEL! EQU 83 SET BUFFER_INPUTNOTE=Cs0
				IF !ERRORLEVEL! EQU 88 SET BUFFER_INPUTNOTE=D-0
				IF !ERRORLEVEL! EQU 68 SET BUFFER_INPUTNOTE=Ds0
				
				IF !ERRORLEVEL! EQU 67 SET BUFFER_INPUTNOTE=E-0
				IF !ERRORLEVEL! EQU 86 SET BUFFER_INPUTNOTE=F-0
				IF !ERRORLEVEL! EQU 71 SET BUFFER_INPUTNOTE=Fs0
				IF !ERRORLEVEL! EQU 66 SET BUFFER_INPUTNOTE=G-0
				
				IF !ERRORLEVEL! EQU 72 SET BUFFER_INPUTNOTE=Gs0
				IF !ERRORLEVEL! EQU 78 SET BUFFER_INPUTNOTE=A-0
				IF !ERRORLEVEL! EQU 74 SET BUFFER_INPUTNOTE=As0
				IF !ERRORLEVEL! EQU 77 SET BUFFER_INPUTNOTE=B-0
				
				
				IF !ERRORLEVEL! EQU 81 SET BUFFER_INPUTNOTE=C-1
				REM  Cs1
				IF !ERRORLEVEL! EQU 87 SET BUFFER_INPUTNOTE=D-1
				REM  Ds1
				
				IF !ERRORLEVEL! EQU 69 SET BUFFER_INPUTNOTE=E-1
				IF !ERRORLEVEL! EQU 82 SET BUFFER_INPUTNOTE=F-1
				REM  Fs1
				IF !ERRORLEVEL! EQU 84 SET BUFFER_INPUTNOTE=G-1
				
				REM  Gs1
				IF !ERRORLEVEL! EQU 89 SET BUFFER_INPUTNOTE=A-1
				REM  As1
				IF !ERRORLEVEL! EQU 85 SET BUFFER_INPUTNOTE=B-1
				
				
				IF !ERRORLEVEL! EQU 73 SET BUFFER_INPUTNOTE=C-2
				REM  Cs2
				IF !ERRORLEVEL! EQU 79 SET BUFFER_INPUTNOTE=D-2
				REM  Ds2
				IF !ERRORLEVEL! EQU 80 SET BUFFER_INPUTNOTE=E-2
				
			)
			IF !ERRORLEVEL! GEQ 48 IF !ERRORLEVEL! LEQ 57 (
				IF !ERRORLEVEL! EQU 50 SET BUFFER_INPUTNOTE=Cs1
				IF !ERRORLEVEL! EQU 51 SET BUFFER_INPUTNOTE=Ds1
				IF !ERRORLEVEL! EQU 53 SET BUFFER_INPUTNOTE=Fs1
				IF !ERRORLEVEL! EQU 54 SET BUFFER_INPUTNOTE=Gs1
				IF !ERRORLEVEL! EQU 55 SET BUFFER_INPUTNOTE=As1
				IF !ERRORLEVEL! EQU 57 SET BUFFER_INPUTNOTE=Cs2
				IF !ERRORLEVEL! EQU 48 SET BUFFER_INPUTNOTE=Ds2
			)
			
			IF !ERRORLEVEL! EQU 219 SET BUFFER_INPUTNOTE=F-2
			IF !ERRORLEVEL! EQU 221 SET BUFFER_INPUTNOTE=G-2
		) ELSE IF !FRAMESHOWTEMP_CURSORINDEX! 1 (
		)
		...
		:: - Dnn = CUT FRAME
		:: - Cnn = END SONG
		:: - Fxx = SPEED BPM IN HEX
		IF !CURSOR_REC! EQU 0 SET "BUFFER_INPUTNOTE="
		IF DEFINED BUFFER_INPUTNOTE GOTO DRAWFRAME
