...
) ELSE IF "!TRACKER_MODE:~0,1!"=="1" (
	IF !ERRORLEVEL! EQU 220 (
		SET "TRACKER_MODE=2"
		GOTO DRAW_TRACKER
	)
) ELSE IF "!TRACKER_MODE:~0,1!"=="2" (
	IF !ERRORLEVEL! EQU 220 (
		SET "TRACKER_MODE=0"
		GOTO DRAW_TRACKER
	)
...
SET "CURSOR_MODE=0"
SET "TRACKER_MODE=0"
REM set "tracker_mode=1Song Information  [25m"
GOTO :EOF
...
:UPDATE_FRAME_EDITOR
ECHO [48;2;!SYCONFIG_COLOR_CHTBG!m[38;2;!SYCONFIG_COLOR_CTTXT!m[10;69H│                                                 │[11;69H│                                                 │[12;69H┤                                                 │[0m
SET "TEMPVARI03=0"
SET "TEMPVARI04=-1"
SET /A "TEMPVARI05=FRAME_COUNTER - 1"
FOR /L %%A IN (0, 1, !TEMPVARI05!) DO (
	FOR %%B IN (!SYMODULE_FRAME!) DO SET /A "TEMPVARI04+=1" & IF !TEMPVARI04! EQU %%A SET "TEMPVARI01=%%B"		
	SET /A "TEMPVARI02=((CURSOR_FRAME >> 4) * ^!(FRAME_COUNTER >> 5)) * 16"
	IF !TEMPVARI01! LSS 10 (
		SET "TEMPVARI04=0!TEMPVARI01!"
	) ELSE (
		SET "TEMPVARI04=%%!TEMPVARI01!"
	)
	IF %%A GEQ !TEMPVARI02! IF !TEMPVARI03! LSS 32 (
		SET /A "TEMPVARI00=((%%A & 15) * 3) + 71"
		IF !TEMPVARI03! LSS 16 (
			SET "TEMPVARI01=[10"
		) ELSE (
			SET "TEMPVARI01=[11"
		)
		IF %%A EQU !CURSOR_FRAME! SET "TEMPVARI01=[5m!TEMPVARI01!"
		ECHO !TEMPVARI01!;!TEMPVARI00!H!TEMPVARI04![25m
		SET /A "TEMPVARI03+=1"
	)
)
GOTO :EOF
